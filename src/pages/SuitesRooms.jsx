    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-10 ml-10 mt-5 mb-5 lg:ml-20 max-lg:ml-15 sm:mr-15 max-sm:mr-10 max-sm:grid-cols-1">
        <div>
          ...
          <p className="text-3xl font-semibold mt-2 max-sm:text-2xl bg-gradient-to-r from-neutral-300 to-neutral-500 text-transparent bg-clip-text">Deluxe Two Suite Room</p>
        </div>
        <div>
          <img className="rounded-md" src={Suite2} alt="" />
          <p className="text-3xl font-semibold mt-2 max-sm:text-2xl bg-gradient-to-r from-neutral-300 to-neutral-500 text-transparent bg-clip-text">Family Suite Room</p>
        </div>
        <div>
          <img className="rounded-md" src={Suite3} alt="" />
          <p className="text-3xl font-semibold mt-2 max-sm:text-2xl bg-gradient-to-r from-neutral-300 to-neutral-500 text-transparent bg-clip-text">Royal Suite Room</p>
        </div>
        <div>
          <img className="rounded-md" src={Suite4} alt="" />
          <p className="text-3xl font-semibold mt-2 max-sm:text-2xl bg-gradient-to-r from-neutral-300 to-neutral-500 text-transparent bg-clip-text">Ambassador Suite Room</p>
        </div>
      </div>
    </>
  );
